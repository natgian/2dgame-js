...
class Feather extends MovableObject {
  ...
  IMAGES = [
    "img/collectibles/gold_feather/_01_gold_feather.png",
    "img/collectibles/gold_feather/_02_gold_feather.png",
    "img/collectibles/gold_feather/_03_gold_feather.png",
    "img/collectibles/gold_feather/_04_gold_feather.png",
  ];

  constructor() {
    super().loadImage("img/collectibles/gold_feather/_01_gold_feather.png");
